...
async function searchBatch3() {
  const client = new pg.Client({ connectionString: 'postgresql://postgres:postgres123@localhost:5432/postgres' });
  await client.connect();

  const newTargets = [
    { name: "Jorlin Ipiña", place: "San Luis", terms: ["jorlin", "jhorlin", "ipiña"] },
    { name: "David Monroy", place: "San Luis", terms: ["david monroy", "monroy"] },
    { name: "Angel Hidalgo", place: "El Chal", terms: ["angel hidalgo", "hidalgo"] },
    { name: "Byron Escobar", place: "Dolores", terms: ["byron escobar", "escobar"] },
    { name: "Yamileth Lopez", place: "Macanche Flores", terms: ["yamileth", "yamileth lopez", "macanche"] },
    { name: "Jaime Sagastume", place: "El Chal", terms: ["jaime sagastume", "sagastume"] }
  ];

  console.log('=== BÚSQUEDA DE NUEVOS CLIENTES (MAYO Y JUNIO) ===\n');
