...
import { Leaf, LogOut, Package, ShoppingCart, FileText, Users, BadgeCheck, Menu, X, ClipboardList, Bell, BellOff, AlertTriangle, XCircle, Box, CheckCircle, CreditCard, Volume2, VolumeX, Search, Trash2, Sparkles, ExternalLink, RefreshCw, Clock, Tag, Download, Shield, Receipt, FileSpreadsheet, FileCheck, MapPin, Send, Map as MapControlIcon } from 'lucide-react';
import { api } from '../api';
...
export function Navigation({ user, activeUser, currentTab, onChangeTab, onLogout, onReturnToAdmin, onImpersonate, isMobile, onShowInstallGuide, showInstallButton }: NavigationProps) {
  ...
  const navItems = [
    ...
    { id: 'recibo-conforme', label: 'Recibo Conforme', icon: FileCheck, roles: ['admin'] },
    ...
    { id: 'client-tracking', label: 'Control Clientes', icon: MapControlIcon, roles: ['admin'] },
